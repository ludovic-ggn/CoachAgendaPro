        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Messagerie /</span> Contact</h4>
                ...
                <div class="col-xl-12">
                  <div class="nav-align-top mb-4">
                    <ul class="nav nav-pills mb-3" role="tablist">
                      <li class="nav-item">
                        <button
                          ...
                          role="tab"
                          data-bs-toggle="tab"
                          data-bs-target="#navs-pills-top-telephone"
                          aria-controls="navs-pills-top-telephone"
                          aria-selected="true"
                        >
                          Telephone
                        </button>
                      ...
                      <li class="nav-item">
                        <button
                          ...
                          aria-controls="navs-pills-top-email"
                          aria-selected="false"
                        >
                          E-mail
                        </button>
                      ...
                      <li class="nav-item">
                        <button
                          ...
                          role="tab"
                          data-bs-toggle="tab"
                          data-bs-target="#navs-pills-top-courrier"
                          aria-controls="navs-pills-top-courrier"
                          aria-selected="false"
                        >
                          Courrier
                        </button>
                      ...
                      <li class="nav-item">
                        <button
                          ...
                          role="tab"
                          data-bs-toggle="tab"
                          data-bs-target="#navs-pills-top-app"
                          aria-controls="navs-pills-top-app"
                          aria-selected="false"
                        >
                    ...
                    <div class="tab-content">
                      <div class="tab-pane fade show active" id="navs-pills-top-telephone" role="tabpanel">
                        <p>
                          <?php echo $infotel; ?>
                        </p>
                      </div>
                      ...
                      <div class="tab-pane fade" id="navs-pills-top-courrier" role="tabpanel">
                        <p>
                          <?php echo $infocourrier; ?>
                        </p>
                      </div>
                      <div class="tab-pane fade" id="navs-pills-top-app" role="tabpanel">
                        <p>
                          <?php echo $infoapp; ?>
                        </p>
                      </div>

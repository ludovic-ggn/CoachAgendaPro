...
>
  <head>
    ...
    <title>Mon Equipe - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Accueil /</span> Mon Equipe</h4>

              <!-- Basic Bootstrap Table -->
              <div class="card">
                <h5 class="card-header">Mon Equipe</h5>
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      <?php
                      $sql="SELECT * FROM membres WHERE equipe='$equipe'";
                      $result=mysqli_query($conn, $sql);
                      if ($result) {
                        while ($row=mysqli_fetch_assoc($result)) {
                          $nom=$row['nom'];
                          ...
                          echo '<tr>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>'.$nom.'</strong></td>
                        <td>'.$poste.'</td>
                        <td>'.$njoueurs.'</td>
                      </tr>';
                        }

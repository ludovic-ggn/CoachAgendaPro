  ...
  if (isset($_POST['submit'])) {
    if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
      ...
      if (in_array($image_type, $allowed_types)) {
        ...
        $sql = "INSERT INTO post (par, le, titre, description, image_data, image_name, image_type) VALUES ('$usermail','$date','$titre','$description','$image_data','$image_name','$image_type')";
...
>
  <head>
    ...
    <title>Poster - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Espace d'échanges /</span> Poster</h4>

              <div class="row">
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Création du Post</h5>
                    </div>
                    <div class="card-body">
                      <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                          ...
                          <textarea
                            ...
                            name="description"
                          ></textarea>
                          <div class="form-text">130 caractères max</div>
                        </div>
                        <button type="submit" class="btn btn-primary" name="submit" accept="image/*">Poster</button>
                      </form>
                    </div>
                  </div>
                </div>

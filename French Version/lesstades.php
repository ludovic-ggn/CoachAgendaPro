...
>
  <head>
    ...
    <title>Les Stades - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Accueil /</span> Les Stades</h4>

              <!-- Basic Bootstrap Table -->
              <div class="card">
                <h5 class="card-header">Les Stades</h5>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="https://www.google.com/maps/place/'.$gps.'"
                                ><i class="bx bx-map-alt me-1"></i> Y Aller</a
                              >
                            </div>
                          </div>
                        </td>

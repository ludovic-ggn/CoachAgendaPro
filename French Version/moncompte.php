...
include 'config.php';
  ...
  $tel= mysqli_real_escape_string($conn, $_POST['tel']);
    ...
    $sql="update membres set nom='$nom',email='$email',tel='$tel' WHERE `email` = '$usermail'";
    $result=mysqli_query($conn,$sql);
    if ($result) {
...
>
  <head>
    ...
    <title>Mon Compte - <?php echo $nomclub;?> - CoachAgendaPro</title>
    <!-- Favicon -->
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a
                href="https://www.github.com/ludovic-ggn"
                target="_blank"
                class="menu-link"
              >
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Paramètre du compte /</span> Mon compte</h4>

              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link active" href="moncompte.php"><i class="bx bx-user me-1"></i> Mon compte</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="mdps.php"
                        ><i class="bx bx-lock-open-alt me-1"></i> Sécurité</a>
                    </li>
                  </ul>
                  <div class="card mb-4">
                    <h5 class="card-header">Mon Compte</h5>
                    <!-- Account -->
                    <div class="card-body">
                      ...
                      <form id="formAccountSettings" method="POST">
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" disabled value="<?= htmlspecialchars($equipe) ?>"/>
                          </div>
                          <div class="mb-3 col-md-6">
                            <label class="form-label">Poste</label>
                            <input class="form-control" type="text" disabled value="<?= htmlspecialchars($poste) ?>" />
                          </div>
                          <div class="mb-3 col-md-6">
                            <label class="form-label">Numero Joueur</label>
                            <input
                              type="text"
                              class="form-control"
                              disabled
                              value="<?= htmlspecialchars($njoueurs) ?>"
                            />
                          </div>
                        </div>
                        <div class="mt-2">

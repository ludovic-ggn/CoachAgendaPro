...
>
  <head>
    ...
    <title>Les matchs a venir - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Les Matchs /</span> A Venir</h4>

              <!-- Basic Bootstrap Table -->
              <div class="card">
                <h5 class="card-header">Les matchs a venir</h5>
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      <?php
                      $sql="SELECT * FROM matchs WHERE `date` > CURDATE() ORDER BY `date` ASC";
                      $result=mysqli_query($conn, $sql);
                      if ($result) {
                        while ($row=mysqli_fetch_assoc($result)) {
                          $date=$row['date'];

...
include '../config.php';
  ...
  if (isset($_POST['submit'])) {
    ...
    $adomicile=mysqli_real_escape_string($conn, $_POST['adomicile']);
    $alexterieur=mysqli_real_escape_string($conn, $_POST['alexterieur']);
    $score=mysqli_real_escape_string($conn, $_POST['score']);
    $equipe=mysqli_real_escape_string($conn, $_POST['equipe']);
    $stade=mysqli_real_escape_string($conn, $_POST['stade']);
    $sql="UPDATE matchs set date='$date', adomicile='$adomicile', alexterieur='$alexterieur', equipe='$equipe', stade='$stade',score='$score' WHERE id=$id";
    $result=mysqli_query($conn, $sql);
    if ($result) {
...
>
  <head>
    ...
    <title>Modification d'un match - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Espace coach/</span> Modification d'un match</h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Modification d'un match</h5>
                    </div>
                    <div class="card-body">
                      <form method="post">
                        <div class="mb-3">
                          <label class="form-label">Date</label>
                          <input type="datetime-local" class="form-control" name="date" value="<?= htmlspecialchars($date); ?>" required />
                        </div>
                        <div class="mb-3">
                          <label class="form-label">A domicile</label>
                          <input type="text" class="form-control" name="adomicile" value="<?= htmlspecialchars($adomicile); ?>" required />
                        </div>
                        <div class="mb-3">
                          <label class="form-label">Score</label>
                          <input type="text" class="form-control" name="score" placeholder="X - X" value="<?= htmlspecialchars($score); ?>" />
                        </div>
                        <div class="mb-3">
                          <label class="form-label">A l'exterieur</label>
                          <input type="text" class="form-control" name="alexterieur" value="<?= htmlspecialchars($alexterieur); ?>" required />
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <select class="form-control" name="stade">
                            <option value="<?php echo $stade; ?>"><?php echo $stade; ?></option>
                              <?php
                              while($fetch_options = mysqli_fetch_array($result)) {
                              ?>
                              <option value="<?php echo $fetch_options['nomstade']; ?>"><?php echo $fetch_options['nomstade']; ?></option>
                              <?php
                              }
                              ?>
                          </select>

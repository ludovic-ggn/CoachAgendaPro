...
include '../config.php';
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql="INSERT INTO entrainements (equipe, jour, heure, stade) VALUES ('$equipe', '$jour', '$heure', '$stade')";
    $result=mysqli_query($conn, $sql);
    if ($result) {
...
>
  <head>
    ...
    <title>Ajouter un entrainement - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Espace coach/</span> Ajout d'un entrainement</h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Ajout d'un entrainenement</h5>
                    </div>
                    <div class="card-body">
                      <form method="post">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          <label class="form-label">Heure</label>
                            <input type="text" class="form-control" name="heure" placeholder="16h00 à 18h00" required />
                        </div>
                        <div class="mb-3">

...
include '../config.php';
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql="INSERT INTO matchs (date,adomicile,alexterieur,equipe,stade,score) VALUES ('$date','$adomicile','$alexterieur','$equipe','$stade','')";
    $result=mysqli_query($conn, $sql);
    if ($result) {
...
>
  <head>
    ...
    <title>Ajout d'un match - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Espace coach/</span> Ajout d'un match</h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Ajout d'un match</h5>
                    </div>
                    <div class="card-body">
                      <form method="post">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="adomicile" required />
                        </div>
                        <div class="mb-3">
                          <label class="form-label">A l'exterieur</label>
                          <input type="text" class="form-control" name="alexterieur" required />
                        </div>
                        <div class="mb-3">

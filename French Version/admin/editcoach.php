...
include '../config.php';
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql="update coach set nom='$nom',email='$mail' WHERE `id` = '$id'";
    $result=mysqli_query($conn, $sql);
    if ($result) {
      if ($usermail == $mailcoach) {
        $_SESSION['coach'] = $mail;
...
>
  <head>
    ...
    <title>Gestion des Coachs - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Espace Coach/</span> Modification d'un coach</h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Modification d'un coach</h5>
                    </div>
                    <div class="card-body">
                      <form method="post">
                        <div class="mb-3">
                          <label class="form-label">Nom Complet</label>
                          <input type="text" class="form-control" name="nom" value="<?= htmlspecialchars($nomcoach); ?>" required/>
                        </div>
                        <div class="mb-3">
                          <label class="form-label">Adresse Mail</label>
                          <input type="email" class="form-control" name="email" value="<?= htmlspecialchars($mailcoach); ?>" required/>
                        </div>
                        <div class="mt-2">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2 col-lg-6 mx-auto">
                          <?php echo '
                          <button type="button" class="btn btn-danger"><a href="resetcoachpass.php?id='.$id.'" style="color: white;">Réinitialiser le mot de passe</a> </button>';?>
                        </div>

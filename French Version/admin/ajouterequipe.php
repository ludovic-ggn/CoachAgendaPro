...
include '../config.php';
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql="INSERT INTO equipe (nomequipe) VALUES ('$nomequipe')";
    $result=mysqli_query($conn, $sql);
    if ($result) {
...
>
  <head>
    ...
    <title>Ajouter une equipe - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Espace coach/</span> Création d'une equipe</h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Création d'un equipe</h5>
                    </div>
                    <div class="card-body">
                      <form method="post">
                        <div class="mb-3">
                          <label class="form-label">Nom de l'équipe</label>
                          <input type="text" class="form-control" name="nomequipe" required />
                        </div>

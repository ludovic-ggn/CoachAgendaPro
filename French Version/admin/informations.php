...
>
  <head>
    ...
    <title>Informations - <?php echo $nomclub;?> - CoachAgendaPro</title>
...
<!-- User -->
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Espace Coach /</span> Informations</h4>

              <!-- Basic Bootstrap Table -->
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Liste des informations</h5>
                  <h6 class="card-subtitle text-muted"><a href="ajouterinformation.php">Envoyer une information</a></h6>
                </div>
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      if ($result) {
                        while ($row=mysqli_fetch_assoc($result)) {
                          ...
                          $message=$row['message'];
                          echo '<tr>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>'.$le.'</strong></td>
                        <td>'.$message.'</td>
                        <td>
                            <a href="deleteinformation.php?id='.$id.'"><i class="bx bx-trash"></i></a>
                        </td>
                      </tr>';
                        }
                      }

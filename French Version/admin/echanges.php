...
>
  <head>
    ...
    <title>Echanges - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Accueil /</span> Espace d'échanges</h4>

              <!-- Images -->
              <div class="row mb-5" data-masonry='{"percentPosition": true }'>
                <?php
                $sql ="SELECT * FROM post ORDER BY id DESC LIMIT 75";
                $result=mysqli_query($conn, $sql);
                if ($result) {

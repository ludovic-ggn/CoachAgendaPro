...
include '../config.php';
  ...
  $row= mysqli_fetch_assoc($result);
  $infotel=$row['infotel'];
  $infomail=$row['infomail'];
  $infocourrier=$row['infocourrier'];
  $infoapp=$row['infoapp'];

  if (isset($_POST['submit'])) {
    $infotel=mysqli_real_escape_string($conn, $_POST['telephone']);
    $infomail=mysqli_real_escape_string($conn, $_POST['email']);
    $infocourrier=mysqli_real_escape_string($conn, $_POST['courrier']);
    $infoapp=mysqli_real_escape_string($conn, $_POST['app']);
    $sql= "UPDATE contact set infotel='$infotel', infomail='$infomail', infocourrier='$infocourrier', infoapp='$infoapp' WHERE id='1'";
    $result=mysqli_query($conn, $sql);
    if ($result) {
...
>
  <head>
    ...
    <title>Contact - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Espace coach/</span> Contact</h4>
                      ...
                      <form method="post">
                        <div class="mb-3">
                          ...
                          <div class="input-group input-group-merge">
                            ...
                            <input type="text" class="form-control" name="telephone" value="<?= htmlspecialchars($infotel);?>" />
                          </div>
                        </div>
                        <div class="mb-3">
                          ...
                          <div class="input-group input-group-merge">
                            ...
                            <input type="text" class="form-control" name="email" value="<?= htmlspecialchars($infomail);?>" />
                          </div>
                        </div>
                        <div class="mb-3">
                          ...
                          <div class="input-group input-group-merge">
                            ...
                            <input type="text" class="form-control" name="courrier" value="<?= htmlspecialchars($infocourrier);?>" />
                          </div>
                        </div>
                        <div class="mb-3">
                          <label class="form-label">Application de messagerie</label>
                          <div class="input-group input-group-merge">
                            <span class="input-group-text"><i class="bx bx-message-rounded-dots"></i></span>
                            <input type="text" class="form-control" name="app" value="<?= htmlspecialchars($infoapp);?>"/>
                          </div>
                        </div>

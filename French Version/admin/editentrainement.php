...
include '../config.php';
  ...
  $sql="SELECT * FROM entrainements WHERE id=$id";
  $result=mysqli_query($conn, $sql);
  $row=mysqli_fetch_assoc($result);
  $equipe=$row['equipe'];
  $jour=$row['jour'];
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql="UPDATE entrainements set equipe='$equipe', jour='$jour', heure='$heure', stade='$stade' WHERE id='$id'";
    $result=mysqli_query($conn, $sql);
    if ($result) {
...
>
  <head>
    ...
    <title>Modification d'un entrainement - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Espace coach/</span> Modification d'un entrainement</h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Modification d'un entrainement</h5>
                    </div>
                    <div class="card-body">
                      <form method="post">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          <label class="form-label">Heure</label>
                            <input type="text" class="form-control" name="heure" value="<?php echo $heure; ?>" required/>
                        </div>
                        <div class="mb-3">

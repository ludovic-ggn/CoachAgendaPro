...
>
  <head>
    ...
    <title>Moderation - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Espace coach/</span> Moderation</h4>
                  ...
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      <?php
                        ...
                        <td>'.$par.'</td>
                        <td>'.$le.'</td>
                        <td><a href="deletepost.php?id='.$id.'"><i class="bx bx-trash"></i></a></td>
                      </tr>';
                          }
                        }
                      ?>

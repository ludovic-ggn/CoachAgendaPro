...
>
  <head>
    ...
    <title>Liste des matchs - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Espace coach /</span> Liste des matchs</h4>

              <!-- Basic Bootstrap Table -->
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Liste des matchs</h5>
                  <h6 class="card-subtitle text-muted"><a href="ajoutermatch.php">Ajouter un match</a></h6>
                </div>
                  ...
                  <table class="table">
                    <thead>
                      <tr>
                        ...
                        <th>Equipe</th>
                        <th>Stade</th>
                        <th>Feuille de match/ Stats</th>
                        <th>Actions</th>
                      </tr>
                    </thead>
                    <tbody class="table-border-bottom-0">
                      <?php
                        $sql="SELECT * FROM matchs ORDER BY date DESC";
                        $result=mysqli_query($conn, $sql);
                        if ($result) {
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="editmatch.php?id='.$id.'"><i class="bx bx-edit-alt me-1"></i> Editer</a>
                              <a class="dropdown-item" href="deletematch.php?id='.$id.'"><i class="bx bx-trash me-1"></i> Supprimer</a>
                              <a class="dropdown-item" href="ajouterfeuilledematch.php?id='.$id.'"><i class="bx bx-import me-1"></i> Ajouter feuille de match</a>
                            </div>
                          </div>
                        </td>
                      </tr>';

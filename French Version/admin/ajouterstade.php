...
$sql="INSERT INTO stades (nomstade,adresse,ville,gps) VALUES('$nomstade', '$adresse', '$ville', '$gps')";
$result=mysqli_query($conn, $sql);
if ($result) {
...
>
  <head>
    ...
    <title>Ajouter un stade - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Espace coach/</span> Ajouter un stade</h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Ajouter un stade</h5>
                    </div>
                    <div class="card-body">
                      <form method="post">
                        <div class="mb-3">
                          <label class="form-label">Nom du stade</label>
                          <input type="text" class="form-control" name="nomstade" required />
                        </div>
                        <div class="mb-3">

...
include '../config.php';
  ...
  $result=mysqli_query($conn, $sql);
  $row=mysqli_fetch_assoc($result);
  $equipe=$row['nomequipe'];

  if (isset($_POST['submit'])) {
    $nomequipe=mysqli_real_escape_string($conn, $_POST['nomequipe']);
    $sql="UPDATE equipe set nomequipe='$nomequipe' WHERE id='$id'";
    $result=mysqli_query($conn, $sql);
    if ($result) {
      if ($nomequipe != $equipe) {
        $sql="UPDATE membres set equipe='$nomequipe' WHERE equipe='$equipe'";
        $resultat=mysqli_query($conn, $sql);
        $sql="UPDATE entrainements set equipe='$nomequipe' WHERE equipe='$equipe'";
        $resultat=mysqli_query($conn, $sql);
...
>
  <head>
    ...
    <title>Modification d'une equipe - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Espace coach/</span> Modification d'une equipe</h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Modification d'un equipe</h5>
                    </div>
                    <div class="card-body">
                      <form method="post">
                        <div class="mb-3">
                          <label class="form-label">Nom de l'equipe</label>
                          <input type="text" class="form-control" name="nomequipe" value="<?= htmlspecialchars($equipe); ?>" required />
                        </div>

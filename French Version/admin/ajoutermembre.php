...
include '../config.php';
  ...
  if (isset($_POST['submit'])) {
    ...
    $subject = 'Votre compte membre - '.$nomclub.'';
    $message = "Bonjour, vous pouvez désormais vous rendre sur l'espace membre grâce à votre adresse mail et votre nouveau mot de passe: $newpass";
    $date=date("Y-m-d H:i:s");
    if (mail($email, $subject, $message)) {
      $newpass = hash('sha256', $newpass); 
      $sql="INSERT INTO membres (email,password,nom,equipe,poste,njoueurs,tel,derniereutilisation) VALUES ('$email','$newpass','$nommembre','$equipe','$poste','$njoueurs','$telephone','$date')";
      $result=mysqli_query($conn, $sql);
      if ($result) {
...
>
  <head>
    ...
    <title>Ajout d'un membre - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Espace coach/</span> Ajout d'un membre</h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Ajout d'un membre</h5>
                    </div>
                    <div class="card-body">
                      <form method="post">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number" class="form-control" name="njoueurs" required />
                        </div>
                        <div class="mb-3">

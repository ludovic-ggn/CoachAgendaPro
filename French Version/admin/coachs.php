        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Espace Coach /</span> Liste des coachs</h4>

              <!-- Basic Bootstrap Table -->
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Liste des coachs</h5>
                  <h6 class="card-subtitle text-muted"><a href="ajoutercoach.php">Ajouter un coach</a></h6>
                </div>
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      if ($result) {
                        while ($row = mysqli_fetch_assoc($result)) {
                          ...
                          $mailcoach=$row['email'];
                          echo '<tr>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>'.$nomcoach.'</strong></td>
                        <td>'.$mailcoach.'</td>
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="editcoach.php?id='.$id.'"
                                ><i class="bx bx-edit-alt me-1"></i> Editer</a
                              >
                              <a class="dropdown-item" href="deletecoach.php?id='.$id.'"

...
>
  <head>
    ...
    <title>Liste des Stades - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Espace coach /</span> Liste des stades</h4>

              <!-- Basic Bootstrap Table -->
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Liste des stades</h5>
                  <h6 class="card-subtitle text-muted"><a href="ajouterstade.php">Ajouter un stade</a></h6>
                </div>
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      if ($result) {
                        while ($row=mysqli_fetch_assoc($result)) {
                          ...
                          $gps=$row['gps'];
                          echo '<tr>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>'.$nomstade.'</strong></td>
                        <td>'.$adresse.'</td>
                        <td>'.$ville.'</td>
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="https://www.google.com/maps/place/'.$gps.'"><i class="bx bx-map-alt me-1"></i> Y Aller</a>
                              <a class="dropdown-item" href="editstade.php?id='.$id.'"><i class="bx bx-edit-alt me-1"></i> Editer</a>
                              <a class="dropdown-item" href="deletestade.php?id='.$id.'"><i class="bx bx-trash-alt me-1"></i> Supprimer</a>
                            </div>
                          </div>
                        </td>
                      </tr>';

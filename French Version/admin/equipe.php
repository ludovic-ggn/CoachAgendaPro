...
>
  <head>
    ...
    <title>Liste des equipes - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Espace coach /</span> Liste des equipes</h4>

              <!-- Basic Bootstrap Table -->
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Liste des equipes</h5>
                  <h6 class="card-subtitle text-muted"><a href="ajouterequipe.php">Ajouter une equipe</a></h6>
                </div>
                      ...
                      <?php
                        ...
                        if ($result) {
                          while ($row=mysqli_fetch_assoc($result)) {
                            ...
                            $sql="SELECT * FROM membres WHERE equipe='$nomequipe'";
                            if ($resultat=mysqli_query($conn, $sql)) {
                              $rowcount=mysqli_num_rows($resultat);
                            }
                            echo '<tr>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i><strong><a href="compositionequipe.php?equipe='.$nomequipe.'">'.$nomequipe.'</a></strong></td>
                        <td>'.$rowcount.'</td>
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="editequipe.php?id='.$id.'"><i class="bx bx-edit-alt me-1"></i> Editer</a>
                              <a class="dropdown-item" href="deleteequipe.php?id='.$id.'"><i class="bx bx-trash me-1"></i> Supprimer</a>
                            </div>
                          </div>
                        </td>
                      </tr>';

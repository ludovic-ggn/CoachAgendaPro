...
>
  <head>
    ...
    <title>Entrainements - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Espace coach /</span> Liste des entrainements par equipe</h4>

              <!-- Basic Bootstrap Table -->
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Liste des entrainements par equipe</h5>
                  <h6 class="card-subtitle text-muted"><a href="ajouterentrainement.php">Ajouter un entrainement</a></h6>
                </div>
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    <thead>
                      <tr>
                        <th>Equipe</th>
                        <th>Nombre d'entrainements par semaine</th>
                      </tr>
                    </thead>
                      ...
                      <?php
                        ...
                        if ($result) {
                          while ($row=mysqli_fetch_assoc($result)) {
                            ...
                            echo '<tr>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i><strong><a href="listeentrainements.php?id='.$id.'">'.$nomequipe.'</a></strong></td>
                        <td>'.$rowcount.'</td>
                      </tr>';
                          }
                        }

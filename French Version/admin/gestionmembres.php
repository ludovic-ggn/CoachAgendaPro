...
>
  <head>
    ...
    <title>Liste des membres - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Espace coach /</span> Liste des membres</h4>

              <!-- Basic Bootstrap Table -->
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Liste des membres</h5>
                  <h6 class="card-subtitle text-muted"><a href="ajoutermembre.php">Ajouter un membre</a></h6>
                </div>
                      ...
                      <?php
                        ...
                        if ($result) {
                          while ($row=mysqli_fetch_assoc($result)) {
                            ...
                            echo '<tr>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i><strong>'.$nommembre.'</strong></td>
                        <td>'.$equipe.'</td>
                        <td>'.$poste.'</td>
                        <td>'.$njoueurs.'</td>
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="editmembre.php?id='.$id.'"><i class="bx bx-edit-alt me-1"></i> Editer</a>
                              <a class="dropdown-item" href="deletemembre.php?id='.$id.'"><i class="bx bx-trash me-1"></i> Supprimer</a>
                            </div>
                          </div>
                        </td>
                      </tr>';

...
include '../config.php';
  ...
  $equipeid=mysqli_real_escape_string($conn, $_GET['id']);
  $sql="SELECT * FROM equipe WHERE id=$equipeid";
  $result=mysqli_query($conn, $sql);
  $row=mysqli_fetch_assoc($result);
...
>
  <head>
    ...
    <title>Liste des entrainements - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Espace coach /</span> Liste des entrainements equipe</h4>

              <!-- Basic Bootstrap Table -->
              <div class="card">
                <h5 class="card-header">Equipe : <?php echo $nomequipe; ?></h5>
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      <?php
                        $sql="SELECT * FROM entrainements WHERE equipe=$nomequipe";
                        $result=mysqli_query($conn, $sql);
                        if ($result) {
                          while ($row=mysqli_fetch_assoc($result)) {
                            ...
                            $stade=$row['stade'];
                            echo '<tr>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i><strong>'.$jour.'</strong></td>
                        <td><span class="badge bg-label-info me-1">'.$heure.'</span></td>
                        <td>'.$stade.'</td>
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="editentrainement.php?id='.$id.'"><i class="bx bx-edit-alt me-1"></i> Editer</a>
                              <a class="dropdown-item" href="deleteentrainement.php?id='.$id.'"><i class="bx bx-trash me-1"></i> Supprimer</a>
                            </div>
                          </div>
                        </td>
                      </tr>';

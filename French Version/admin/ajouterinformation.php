...
include '../config.php';
  ...
  if (isset($_POST['submit'])) {
    ...
    $le= date("Y-m-d H:i:s");
    $sql="INSERT INTO informations (le,message,couleur) VALUES ('$le','$message','$couleur')";
    $result=mysqli_query($conn, $sql);
    if ($result) {
...
>
  <head>
    ...
    <title>Envoyer une information - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Espace coach/</span> Envoyer une information</h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Envoyer une information</h5>
                    </div>
                    <div class="card-body">
                      <form method="post">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <select class="form-control" name="couleur">
                            <option value="primary">Violet</option>

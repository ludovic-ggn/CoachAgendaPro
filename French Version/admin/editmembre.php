...
include '../config.php';
  ...
  $equipe=$row['equipe'];
  $poste=$row['poste'];
  $njoueurs=$row['njoueurs'];
  $tel=$row['tel'];
  $email=$row['email'];

  if (isset($_POST['submit'])) {
    $nommembre=mysqli_real_escape_string($conn, $_POST['nom']);
    $equipe=mysqli_real_escape_string($conn, $_POST['equipe']);
    $poste=mysqli_real_escape_string($conn, $_POST['poste']);
    $njoueurs=mysqli_real_escape_string($conn, $_POST['njoueurs']);
    $tel=mysqli_real_escape_string($conn, $_POST['tel']);
    $email=mysqli_real_escape_string($conn, $_POST['email']);

    $sql="UPDATE membres set nom='$nommembre', equipe='$equipe', poste='$poste', njoueurs='$njoueurs', tel='$tel', email='$email' WHERE id=$id";
    $result=mysqli_query($conn, $sql);
    if ($result) {
...
>
  <head>
    ...
    <title>Modification d'un membre - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Espace Coach/</span> Modification d'un membre</h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Modification d'un membre</h5>
                    </div>
                    <div class="card-body">
                      <form method="post">
                        <div class="mb-3">
                          <label class="form-label">Nom complet</label>
                          <input type="text" class="form-control" name="nom" value="<?= htmlspecialchars($nommembre); ?>" required />
                        </div>
                        <div class="mb-3">
                          ...
                          <select class="form-control" name="equipe">
                            ...
                            <?php
                              ...
                              ?>
                            <option value="<?php echo $fetch_options['nomequipe']; ?>"><?php echo $fetch_options['nomequipe']; ?></option>
                              <?php
                              }
                              ?>
                          </select>
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="poste" value="<?= htmlspecialchars($poste);?>" required />
                        </div>
                        <div class="mb-3">
                          <label class="form-label">Numero de joueur</label>
                          <input type="number" class="form-control" name="njoueurs" value="<?= htmlspecialchars($njoueurs); ?>" required />
                        </div>
                        <div class="mb-3">
                          <label class="form-label">Telephone</label>
                          <input type="text" class="form-control" name="tel" value="<?= htmlspecialchars($tel);?>" />
                        </div>
                        <div class="mb-3">
              ...
              <div class="row">
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Réinitialisation du mot de passe</h5>
                    </div>
                    <div class="card-body">
                        <div class="row mt-3">
                        <div class="d-grid gap-2 col-lg-6 mx-auto">
                          <?php echo '
                          <button type="button" class="btn btn-danger"><a href="resetmembrepass.php?id='.$id.'" style="color: white;">Réinitialiser le mot de passe</a> </button>';?>
                        </div>
                        <p class="card-text" style="margin: 10px;">
                        En cas de réinitialisation du mot de passe un mail est envoyé au propriétaire du compte avec le nouveau mot de passe
                      </p>
                      </div>
                    </div>
                  </div>

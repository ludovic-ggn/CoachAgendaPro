...
include '../config.php';
  ...
  $nomequipe=mysqli_real_escape_string($conn, $_GET['equipe']);
?>
<!DOCTYPE html>
...
>
  <head>
    ...
    <title>Composition des equipes - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Espace coach /</span> Composition des equipes</h4>
                      ...
                      <?php
                        ...
                        if ($result) {
                          while ($row=mysqli_fetch_assoc($result)) {
                            ...
                            $numero=$row['njoueurs'];
                            echo '<tr>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i><strong>'.$nomcomplet.'</strong></td>
                        <td>'.$poste.'</td>
                        <td>'.$numero.'</td>
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="editmembre.php?id='.$id.'"
                                ><i class="bx bx-edit-alt me-1"></i> Modifier</a
                              >
                              <a class="dropdown-item" href="deletemembre.php?id='.$id.'"

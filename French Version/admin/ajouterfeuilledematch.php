...
if(file_exists("../upload/feuillematch/".$filename)){
 die("Sorry the file already exists");
 }else{
 move_uploaded_file($_FILES['pdf']['tmp_name'],"../upload/feuillematch/".$id);
...
>
  <head>
    ...
    <title>Ajout d'une feuille de match - <?php echo $nomclub;?> - CoachAgendaPro</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Espace coach/</span> Ajout d'une feuille de match</h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Ajouter une feuille de match</h5>
                    </div>
                    <div class="card-body">
                      <form action="" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                          <label class="form-label" for="basic-icon-default-fullname">Feuille de match</label>
                          <div class="input-group input-group-merge">
                            <span id="basic-icon-default-fullname2" class="input-group-text"><i class="bx bxs-file-pdf"></i></span>
                            <input type="file" class="form-control" name="pdf" id="pdf"/>
                          </div>
                          <div class="form-text">Pour des raisons de compatibilité seules les fichiers PDF sont acceptés</div>
                        </div>
                        <button type="submit" name="submit" class="btn btn-primary">Ajouter / Remplacer</button>
                      </form>
                    </div>
                  </div>
                </div>
